...
const TokenCollateralTecPriceProviderFallback = artifacts.require('./V2TokenCollateralTecPriceProviderFallback.sol');
...
module.exports = async callback => {
  try {
    ...
    const priceProvider = await TokenCollateralTecPriceProviderFallback.at(config.TokenCollateralTec.PriceProvider);
